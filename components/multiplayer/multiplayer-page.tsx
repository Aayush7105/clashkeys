      ...
      <div className="relative max-w-3xl w-full space-y-10">
        ...
        <div className="rounded-2xl border border-neutral-700 bg-neutral-900 p-6 sm:p-8 shadow-[0_0_0_1px_rgba(255,255,255,0.05)] font-mono tracking-tight">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <button
              onClick={createRoom}
              className="rounded-xl bg-[#e2b714] px-5 py-2.5 text-sm font-semibold text-[#1a1b1f] tracking-wide hover:brightness-110 cursor-pointer"
            >
              Create room
            </button>
            <button
              onClick={joinRoom}
              className="rounded-xl border border-[#3a3f49] px-5 py-2.5 text-sm font-semibold tracking-wide text-[#e2e2e2] hover:border-[#e2b714] cursor-pointer"
            >
              Join room
            </button>
          </div>
