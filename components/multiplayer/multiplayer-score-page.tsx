      ...
      <div className="relative z-10 mx-auto flex min-h-screen lg:h-screen lg:min-h-0 lg:max-h-screen w-full max-w-7xl flex-col justify-start lg:justify-start gap-2 lg:gap-2.5 px-3 py-4 lg:py-6 font-mono lg:overflow-hidden">
        <div className="flex flex-wrap items-center justify-between gap-1.5">
          <p className="text-2xl font-semibold uppercase tracking-normal text-neutral-400 md:text-3xl">
            Test completed
            <br />
            <span className="text-lg tracking-normal md:text-xl">room {roomId}</span>
          </p>
          <button
            onClick={() => setShowLeaderboardOnly((value) => !value)}
            className="w-44 rounded-lg ring ring-[#3a3f49] px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-[#d1d0c5] transition-colors hover:ring-[#e2b714] hover:text-[#e2b714] cursor-pointer"
            type="button"
          >
        ...
        <section className="flex justify-center items-center mt-2.5">
